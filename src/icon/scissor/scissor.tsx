...
export const ScissorIcon = (props: IconProps) => {
  ...
  return (
    ...
    >
      <path d="m40.293 7.707-23.05 23.05m0 0a6 6 0 1 0-8.485 8.485 6 6 0 0 0 8.485-8.485Zm13.514 0a6 6 0 1 0 8.485 8.485 6 6 0 0 0-8.485-8.485Zm0 0L7.707 7.707" />
    </svg>
  )
}
