...
export const CloseCircleIcon = (props: IconProps) => {
  ...
  return (
    ...
    >
      <path d="m17.643 17.643 6.364 6.364m0 0 6.364 6.364m-6.364-6.364 6.364-6.364m-6.364 6.364-6.364 6.364M42 24c0 9.941-8.059 18-18 18S6 33.941 6 24 14.059 6 24 6s18 8.059 18 18Z" />
    </svg>
  )
}
