...
export const ArrowRiseIcon = (props: IconProps) => {
  ...
  return (
    ...
    >
      <path d="M23.992 6.01a.01.01 0 0 1 .016 0l9.978 11.974a.01.01 0 0 1-.007.016H14.02a.01.01 0 0 1-.007-.016l9.978-11.975Z" />
      <path d="m24 6 10 12H14L24 6Z" fill="currentColor" stroke="none" />
      <path d="M26 42h-4V16h4z" />
      <path fill="currentColor" stroke="none" d="M26 42h-4V16h4z" />
    </svg>
  )
}
